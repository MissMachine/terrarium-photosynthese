...
app._unparsable_cell(
    ...
    CSV_PATH = BASE_DIR / \"data\" / \"photosynthese_waha\" / \"raw\" /
    ...
    \"\"\"
        out = {\"CO2\": None, \"LUX\": None, \"T\": None, \"H\": None}
    ...
    def main():
        ...
        with open(CSV_PATH, \"a\", newline=\"\", encoding=\"utf-8\") as f:
            writer = csv.DictWriter(
                f,
                fieldnames=[\"timestamp\", \"co2_ppm\", \"lux\", \"temp_c\", \"hum_pct\", \"raw\"]
            )
            if not file_exists:
                writer.writeheader()
